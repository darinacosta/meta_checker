$(function() {
  ...
  console.log(requested_meta[i]);
    if (requested_meta[i].error_view) {
      $("#meta_comparison_" + requested_meta[i].id).html("<table><tr><td style='width:34px;padding-left: 32px;'><b># " + requested_meta[i].id + ":</b></td><td>" + requested_meta[i].error_view + "</td></tr></table><hr>");
    } else {
      var meta_data = {
